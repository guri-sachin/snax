...
import BlogsDsc from "./pages/Homepage/BlogsDsc";
    ...
    <Router>
      <CartProvider>
        ...
        <Routes>
          ...
          <Route index path="/Instafeed" element={<Instafeed />} />
          <Route index path="/Blogs" element={<Blogs />} />
          <Route index path="/BlogsDsc/:slug" element={<BlogsDsc />} />
          ...
          <Route index path="/Product/:slug/:encryptedId" element={<Product />} />
          ...
          <Route index path="/Gifts/:slug/:encryptedId" element={<Gifts />} />
