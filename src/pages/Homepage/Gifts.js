      ...
      <div className="container mx-auto lg:flex lg:space-x-6 mt-10">
          ...
          <div className="grid grid-cols-4 gap-2 mx-16">
            ...
            >
              <img
                src={selectedImage}
                alt="Selected"
                className={`w-full h-full  transform transition-transform duration-300 ${zoom ? "scale-150" : "scale-100"
                  }`}
                style={{
        ...
        <div className="px-4 lg:px-8 lg:w-1/2">
          ...
          <div className="flex items-center mb-4">
            ...
            <span className="text-gray-500">FREE Shipping.
            </span>
      ...
      <div className="container mx-auto lg:flex lg:space-x-6 mt-10  border-gray-200 rounded-lg  lg:px-12">
        ...
        <div className="container mx-auto lg:flex lg:space-x-6 mt-5  border-gray-200 rounded-lg p-4 ">
          ...
          <div className="">
            ...
            {isExpanded && (
              <div>
                <p className='text-sm text-gray-600 text-justify '>{product.detaildes}</p>
              </div>
            )}
          </div>
        </div>
