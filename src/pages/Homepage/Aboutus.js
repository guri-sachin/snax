...
const MyDesign = () => {
 ...
 useEffect(() => {
  ...
  <img 
            src={`${process.env.PUBLIC_URL}/img/home/combine1.webp`}
  ...
  />
    ...
    <div className="flex flex-col lg:flex-row justify-center items-center p-6 px-8  lg:p-12 gap-10">
      ...
      <div className="lg:w-1/3 w-full flex justify-center lg:justify-start mb-6 lg:mb-0">
        <img
          ...
          src={`${process.env.PUBLIC_URL}/img/home/combine.webp`}
    ...
    <div className="flex flex-col lg:flex-row justify-center items-center p-6 px-8  lg:p-12 gap-10">
      ...
      <div className="lg:w-1/3 w-full flex justify-center lg:justify-start mb-6 lg:mb-0">
        <img
                  src={`${process.env.PUBLIC_URL}/img/home/combine2.webp`}
    ...
    <div className="flex flex-col lg:flex-row justify-center items-center p-6 px-8  lg:p-12 gap-10">
      ...
      <div className="lg:w-1/3 w-full flex justify-center lg:justify-start mb-6 lg:mb-0">
        <img
                          src={`${process.env.PUBLIC_URL}/img/home/combine3.webp`}
