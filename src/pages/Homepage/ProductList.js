...
const [error, setError] = useState(''); 
  ...
  console.log("ProductList",filteredProd)
  return (
    <>
    <Navbar/>
  ...
  <div key={product.id} className="relative p-2 sm:p-2 md:p-4 lg:p-4 bg-white rounded-md" onClick={() => handleProductClick(product)}>
    {/* On Sale Badge */}
