...
const ProductCard = ({ image, title, price,offer,mrp }) => {
  ...
  return (
    ...
    >
      ...
      {/* Image */}
      <div className={`overflow-hidden ${isHovered ? 'transform scale-80' : ''}`}>
        <img
          src={image}
          alt={title}
      ...
      <div className="text-center mt-4">
        ...
        <div className="flex justify-center items-center gap-2">
            ...
            <p className="text-sm md:text-lg font-semibold text-red-600 ">From ₹{price}</p>
            <p className="text-sm text-gray-900 line-through">MRP: ₹. {mrp}</p>
              ...
              currentProducts.map((product) => (
                <div onClick={() => handleProductClick(product)}>
                  <ProductCard
                    ...
                    mrp={product.product_price ? product.product_price.split(',')[0] : 'N/A'} // Show only the first part of the price
