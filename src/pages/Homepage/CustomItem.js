...
const ProductGrid = () => {
  ...
  const [page, setPage] = useState('CustomItem'); // State to hold the page input
    ...
    <>
      ...
      <div className="container mx-auto p-6 px-[50px]">
        <div className="flex">
              ...
              {filteredProducts.map((product) => (
                ...
                >
                  ...
                  <div className="flex justify-center items-center gap-2">
                    ...
                    <p className="text-gray-600 text-red-600">₹{product.gifts_price ? product.gifts_price.split(',')[0] : 'N/A'}</p>
          ...
          {/* Right Section: 35% */}
          <div className='w-full md:w-1/3 grid grid-cols-1  ml-6 overflow-y-scroll scrollbar-hide'>
          <div className="w-full  grid grid-cols-1 gap-4 h-20  ">
            {selectedProducts.length > 0 ? (
              selectedProducts.map((product) => (
                <div
                  key={product.id}
                  className="border p-4 rounded-lg shadow-lg text-center cursor-pointer hover:shadow-xl h-50 "
