...
const CustomiseGift = () => {
  ...
  const handleProductClick = (hamper) => {
    ...
    navigate(`/product/${hamper.product_slug.replace(/\s+/g, '-')}`, { state: { hamper, id: hamper.product_id } });
...
actualp_discount
        ...
        <div className="p-4">
          ...
          <div className="flex justify-center items-center gap-2">
            ...
            <p className="text-sm text-red-600 line-through">M.R.P: ₹{hamper.product_price
            }</p>
          </div>
        </div>
      </div>
