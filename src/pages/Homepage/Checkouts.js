...
useEffect(() => {
  ...
  console.log("totalAmount jk",totalAmount,discount)
    return totalAmount;
  };
  
  console.log("Selected Payment Method:", paymentMethod);
console.log("Calculated Total:", calculateTotal(paymentMethod));
...
setLoading(true);
  ...
  console.log("persent",discountPercentage)
    ...
    <label htmlFor="cod">Cash on Delivery</label>
      ...
      <div className="mt-6 border-t pt-4">
        <div className="flex justify-between items-center font-bold text-lg">
          ...
          <p>
          INR ₹ {finalTotal > 0 ? finalTotal.toFixed(2) : initialTotal.toFixed(2)}
