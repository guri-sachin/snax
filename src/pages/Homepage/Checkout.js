...
const CheckoutPage = () => {
  ...
  const { cart } = useCart();
    ...
    console.log(productData);  // This will show the product data passed from the previous page
    ...
    try {
      ...
      const options = {
        ...
        handler: async function (response) {
          console.log('Payment Success:', orderData.orderId);
  ...
  console.log("payloda ship",payload)
  ...
  console.log("end of ",shiprocketPayload)
  ...
  //   const orderUrl = 'http://localhost:4000/api/create-order'; // Your Node.js server URL
  //   const paymentOptions = {
  //     amount,
  //     currency: 'INR'
  //   };
  ...
  //   try {
  //     const { data: order } = await axios.post(orderUrl, paymentOptions);
  ...
  //         // You can call your backend to verify the payment status and store transaction details
  //       },
  //       prefill: {
  //         name: 'gurdeep',
  //         email: 'gurisachin09@gmail.com',
  //         contact: '8199818957'
  //       },
  //       theme: {
  //         color: '#F37254'
