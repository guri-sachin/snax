...
const Homepage = () => {
  ...
  const homeHandle = (categore) => {
    navigate("/gifthamper", { state: { category: categore } });
    console.log("Selected Category:", categore);
  };
        ...
        <div className="hidden md:inline-block slider-container w-[100%]">
          <Slider {...settings}>
            {activeBanners.map((banner, index) => (
              <div key={banner.id} >
                <div className="image-container"  onClick={() => homeHandle(banner.categore)}>
                  <img
        ...
        <div className="inline-block md:hidden slider-container w-[100%]">
          <Slider {...settings}>
            {mobileBanners.map((banner, index) => (
              <div key={banner.id}  onClick={() => homeHandle(banner.categore)}>
