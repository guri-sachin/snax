...
console.log("s",products)
  ...
  {products.map((product) => (
    ...
    >
      {/* Save Button */}
      <button className="absolute top-2 right-2 bg-orange-500 text-white text-sm font-bold px-2 py-1 rounded z-10">
        Save {product.
actualp_discount
}%
      </button>
      ...
      <p className="text-xl font-bold text-red-600">
        <span className="text-md text-gray-500 line-through">
          ₹{product.product_price ? product.product_price.split(',')[0] : 'N/A'}
        </span>
