...
const handleSubmit = async (e) => {
  ...
  return (
    ...
    GET EXCITING OFFERS AND EARLY ACCESS TO OUR SALE BY SUBSCRIBING NOW.
</p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center space-y-4 max-w-md mx-auto mt-8">
        ...
        <input
          ...
          placeholder="E-mail"
required
          className="border border rounded-full px-6 py-2 w-full outline-none focus:ring-2 focus:ring-orange-600 focus:border-transparent"
        />
        <button      type="submit"   className="hover:bg-orange-600 hover:text-white bg-white text-black py-2 px-8 rounded-full text-lg border border-orange-600 transition duration-300">
          Subscribe
        </button>
      </form>
