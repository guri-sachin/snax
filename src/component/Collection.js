...
const ProductCard = ({ image, title, price, mrp, save }) => {
  ...
  return (
    <div
      className={`relative overflow-hidden p-2 min-h-[250px] rounded-lg transition-all duration-300 mx-4 ${
  ...
  height="270"          // Set explicit height
...
const handleProductClick = (product) => {
  ...
  return (
    <div className="py-12 px-4 min-h-[250px]  md:py-12">
