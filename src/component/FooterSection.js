    ...
    <div className="bg-white py-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
        ...
        <div className="flex justify-center space-x-8 ">
          ...
          <img src="../img/home/2.png" alt="Secure Payment" className="md:mx-auto mb-2 h-[50px]" />

          <p className="text-[#d4af37] font-semibold mt-2">FAST DELIVERY</p>
          </div>
          {/* Secure Payment */}
          <div className="text-center">
            <FaShieldAlt className="text-5xl text-[#d4af37] mx-auto" />
            <p className="text-[#d4af37] font-semibold mt-2">SECURE PAYMENT</p>
          </div>
          {/* Customer Support */}
          <div className="">
          <img src="../img/home/1.png" alt="Fast Delivery" className="md:mx-auto mb-2 h-[50px]" />
            <p className="text-[#d4af37] font-semibold mt-2">CUSTOMER SUPPORT</p>
          </div>
        </div>
