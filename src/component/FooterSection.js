...
const ServiceSocialBar = () => {
  return (
    <div className="bg-white py-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
        ...
        <div className="flex justify-center space-x-8 ">
          ...
          <p className="text-gray-800 font-semibold mt-2">FAST DELIVERY</p>
          </div>
          {/* Secure Payment */}
          <div className="text-center">
            <FaShieldAlt className="text-5xl text-[#b8860b] mx-auto  h-[50px] w-auto" />
            <p className="text-gray-800 font-semibold mt-2">SECURE PAYMENT</p>
          </div>
          {/* Customer Support */}
          <div className="text-center">
          <FaHeadset className="text-5xl text-[#b8860b] mx-auto  h-[50px] w-auto" />

            <p className="text-gray-800 font-semibold mt-2">CUSTOMER SUPPORT</p>
          </div>
        </div>
    ...
    <a
      ...
      className="fixed bottom-4 right-4 bg-green-500 p-4 rounded-full shadow-lg hover:bg-green-600 transition duration-300 z-20"
      target="_blank"
