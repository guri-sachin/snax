...
<div className="flex flex-col items-center">
  ...
  <div className="relative flex items-center w-full mt-2 space-x-4">
    ...
    <button
      ...
      className="absolute left-0 p-2 bg-gray-200 rounded-full shadow-md z-10"
      aria-label="Previous"
    >
      <svg
    ...
    <div className="flex w-full overflow-hidden mt-2 space-x-4 flex-wrap text-center justify-center">
      ...
      <div className="hidden sm:block w-full sm:w-64 md:w-72 p-4 bg-white border border-gray-300 rounded-lg shadow-lg mb-4 text-center">
        <h3 className="text-md font-bold mb-2">
    ...
    <button
      ...
      className="absolute right-0 p-2 bg-gray-200 rounded-full shadow-md z-10"
      aria-label="Next"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
