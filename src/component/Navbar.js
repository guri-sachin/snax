        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-2 md:mt-4">
          <div className="flex items-center justify-between h-16 md:h-[80px]">
            ...
            <div className="flex-shrink-0" aria-label="Home page">
              <Link to="/">
                <img className="h-10 md:h-[70px] md:w-[80px] lg:w-auto" src="../img/home/logo.webp" alt="Logo" />
            ...
            <div className="hidden md:block">
              <div className="md:ml-[0px] lg:ml-[0px]  flex items-end lg:space-x-2 xl:space-x-4">
                <Link to="/ProductList/SuperSnacks" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm md:text-[12px] xl:text-[16px] font-medium capitalize md:uppercase"> Super Snacks &nbsp;&nbsp;|&nbsp;&nbsp;</Link>
                <Link to="/ProductList/DryFruits" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm md:text-[12px]  xl:text-[16px] font-medium capitalize md:uppercase"> Dry Fruits &nbsp;&nbsp;|&nbsp;&nbsp;</Link>
                <Link to="/chocolate" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:text-[12px]  xl:text-[16px] md:uppercase"> Chocolate &nbsp;&nbsp;|&nbsp;&nbsp;</Link>
                <Link to="/gifthamper" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium  md:text-[12px] xl:text-[16px] capitalize md:uppercase"> Healthy Gifting &nbsp;&nbsp;|&nbsp;&nbsp;</Link>
                <Link to="/ProductList/Premix" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm  md:text-[12px] xl:text-[16px] font-medium capitalize md:uppercase"> Premix &nbsp;&nbsp;|&nbsp;&nbsp;</Link>
                <Link to="/contactus" className="text-[#8A0404] hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase md:text-[13px] xl:text-[16px]"> Contact US &nbsp;&nbsp;</Link>
              </div>
            </div>
