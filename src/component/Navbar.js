...
const Navbar = () => {
  ...
  <h1
    className={`text-center text-white text-sm md:text-lg transform transition-all duration-1000 ease-in-out ${
      currentBannerIndex % 2 === 0
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-2 md:mt-4">
          <div className="flex items-center justify-between h-16 md:h-[80px]">
            ...
            <div className="flex-shrink-0" aria-label="Home page">
              <Link to="/">
              <img className="h-10 md:h-[70px] md:w-[100px] lg:w-auto" src="../img/home/logo.webp" alt="Logo" />
            ...
            <div className="hidden md:block">
              <div className="md:ml-[0px] lg:ml-[0px]  flex items-end lg:space-x-2 xl:space-x-4">
              <Link to="/ProductList/SuperSnacks" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase">Super Snacks &nbsp;&nbsp;|</Link>
  <Link to="/ProductList/TrailMixes" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase">Trail Mixes &nbsp;&nbsp;|</Link>
  <Link to="/ProductList/BreakfastCereals" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase">Breakfast Cereals &nbsp;&nbsp;|</Link>
  <Link to="/gifthamper" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase"> Healthy Gifting &nbsp;&nbsp;|</Link>
    <Link to="/ProductList/Premix" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase"> Premix &nbsp;&nbsp;|</Link>
  ...
  <Link to="/contactus" className="text-[#8A0404] hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase">Contact US &nbsp;&nbsp;</Link>
            ...
            <div className="md:hidden">
              <div className="flex items-center space-x-4 mx-4 ">
                ...
                >
                  ...
                  <BsCart className="text-xl sm:text-2xl" aria-label="cart"/> {/* Smaller size for mobile */}
                ...
                <a onClick={checkUserEmail} className="text-gray-800 hover:text-gray-600">
                  <FaUser className="text-xl sm:text-2xl" aria-label="my account"/>
                </a>
    ...
    <Link to="/ProductList/TrailMixes" className="text-gray-800 hover:text-[#8A0404] block px-3 py-2 rounded-md text-base font-medium">Trail Mixes</Link>
    <Link to="/ProductList/BreakfastCereals" className="text-gray-800 hover:text-[#8A0404] block px-3 py-2 rounded-md text-base font-medium">Breakfast Cereals</Link>
