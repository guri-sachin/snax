...
const Navbar = () => {
  ...
  <span className="text-gray-500">|</span>
  <Link to="/gifthamper" className="text-gray-800 hover:text-[#8A0404] rounded-md text-sm font-medium md:text-[12px] xl:text-[14px] capitalize md:uppercase">Healthy Gifting</Link>
  <span className="text-gray-500">|</span>
