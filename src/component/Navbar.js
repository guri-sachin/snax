...
const Navbar = () => {
  ...
  <Link to="/ProductList/DryFruits" className="text-gray-800 hover:text-[#8A0404] px-0 py-2 rounded-md text-sm font-medium capitalize md:uppercase">Dry Fruits &nbsp;&nbsp;|</Link>
