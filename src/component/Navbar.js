...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const fetchBanners = async () => {
      try {
        const response = await fetch('http://localhost:4000/api/topBannertext'); // API endpoint
        if (!response.ok) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-2 md:mt-4">
          <div className="flex items-center justify-between h-16 md:h-[80px]">
            ...
            <div className="flex-shrink-0">
              <Link to="/">
              <img className="h-10 md:h-[70px] md:w-[100px] lg:w-auto" src="../img/home/logo.png" alt="Logo" />
